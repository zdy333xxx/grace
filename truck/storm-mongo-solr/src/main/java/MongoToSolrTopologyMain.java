...
public class MongoToSolrTopologyMain {
    ...
    public static void main(String[] args) throws InterruptedException, UnknownHostException {
        ...
        builder.setBolt("solr-writter", new SolrWritter(), WritterCount).shuffleGrouping("mongo-reader");
        ...
        conf.put("source_collection", "query_qgrk_backup");   //query_person_photo query_qgrk_backup

        //目标集合
        conf.put("solr_url", "http://localhost:7070/solr/mongo_test");

//        conf.put("solr_core", "mongo_test");
//        conf.put("solr_port", 7070);
